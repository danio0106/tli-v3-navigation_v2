...
- **Native Overlay Worker Live Validation (v5.86.0):** user-confirmed in-game that overlay works correctly on native overlay-worker path. Treat `v5.86.0` as production-validated overlay baseline for next migration phases.
